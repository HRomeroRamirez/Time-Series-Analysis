...
macroData <- read_excel(file.path(inputsFolder, "RawDataPRQuarterly.xlsx"))
...
ts_hcpi <- ts(macroData[["HCPI - PR"]], start = c(2008, 10), frequency = 4)
ts_ccpi <- ts(macroData[["CCPI - PR"]], start = c(2008, 10), frequency = 4)
ts_ie2 <- ts(macroData[["IE2 - US"]], start = c(2008, 10), frequency = 4)
